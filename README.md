...
- По умолчанию — устанавливается стабильная проверенная версия панели из нашего форка (рекомендуется)
...
|------|-----------|
| **ВЕРСИЯ ПАНЕЛИ** | |
| По умолчанию | Стабильная проверенная версия панели (рекомендуется) |
