...
> **Статус 2026-08-10:** реализовано во встроенном vendored manager. Актуальное
> описание: [PANEL-HTTPS.md](PANEL-HTTPS.md). Всё ниже — неизменяемый исторический
> план старой patch-stack архитектуры и не является инструкцией по установке.
