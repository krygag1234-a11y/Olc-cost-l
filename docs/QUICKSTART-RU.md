...
4. Если известен только публичный HTTP/IP Jitsi, нажмите **«Найти HTTPS-домен»**, проверьте найденный `https://domain:443` и нажмите **«Использовать»**. Комната при этом не меняется.
