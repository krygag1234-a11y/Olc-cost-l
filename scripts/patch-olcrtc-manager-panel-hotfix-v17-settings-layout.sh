...
if needle not in t:
    print("[patch-v17-settings-layout] pattern not found (skip)"); raise SystemExit(0)
    sys.exit(0)
...
if footer not in t:
    print("[patch-v17-settings-layout] footer not found (skip)"); raise SystemExit(0)
    sys.exit(0)
...
p.write_text(t)
print("[patch-v17-settings-layout] ok"); raise SystemExit(0)
PY
