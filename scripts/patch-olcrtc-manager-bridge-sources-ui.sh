...
# Adds a sources management section: list of sources with toggles, labels,
# ability to add/remove sources, and apply button.
...
def repl(old, new, label, guard=None):
    ...
    if old in t:
        ...
        print(f"[patch-bridge-sources-ui] WARN {label}: anchor not found")

# --- 1. Add sources state + fetch/save inside BridgesSettingsFields ---
repl(
...
# --- 2. Add sources section at end of BridgesSettingsFields ---
# Anchor: exact text at end of BridgesSettingsFields return
repl(
