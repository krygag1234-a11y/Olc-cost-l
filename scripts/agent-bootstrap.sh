...
install_cli_symlinks() {
  local s
  for s in olc-feature.sh olc-update.sh olc-sync-panel-host.sh olc-split-analyze.sh olc-vps-backup.sh olc-vps-snapshot.sh olc-panel-verify.sh olc-cleanup-caches.sh olc-purge.sh olc-backup.sh olc-reinstall.sh; do
