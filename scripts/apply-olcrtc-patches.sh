...
apply_manager() {
  ...
  bash "$SCRIPT_DIR/patch-olcrtc-manager-panel-randomization-ui-full.sh" "$MGR_REPO/src/main.tsx"
  bash "$SCRIPT_DIR/patch-olcrtc-manager-panel-selective-randomization-ui.sh" "$MGR_REPO/src/main.tsx"
